...
def convert_to_anki(infile,verbose,debug,save_dir):
    ...
    0. Get Anki
    1. Install the Media Import add-on: https://ankiweb.net/shared/info/1531997860
    2. import the files generated by this script.  They go into a deck named "Media Import"
