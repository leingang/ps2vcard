...
{
 var nhowLong = totalTimeoutMilliseconds - warningTimeoutMilliseconds - 2000; var nTimeMins = Math.round(totalTimeoutMilliseconds / 60000); var sOK = "OK"; var timeoutWarningMsg = "Your session is about to expire."; var sLongMsg = "As a security precaution, sessions end after"; sLongMsg += " "+nTimeMins+" "; sLongMsg += "minutes of inactivity. <br/><br/>Click OK to continue your current session."; var shtml = "<div id='msgcontainer' class='ps_box-msgcontainer' role='alertdialog' aria-describedby='alertmsg'><div id='alertmsg' class='ps_box-msgalert'><div id='shortmsg' class='ps_box-msgshort'>"; shtml += timeoutWarningMsg; shtml += "</div><div id='msgnum' class='ps_box-msgnum'></div><div id='othermsg' class='ps_box-msgother'></div><div id='longmsg' class='ps_box-msglong'>"+sLongMsg+"</div></div>"; shtml += "<div id='buttoncontainer' class='ps_box-msgactions'><div class='ps_box-button' id='div#ICOK'><span id='#ICOK$span' class='ps-button-wrapper' title='Ok (Enter)'><a id='#ICOK' class='ps-button' role='button' href='javascript:setupTimeout2();closeLastModal();'>"; shtml += "<span class='ps-text'>"+ sOK+"</span></a></span></div></div></div>"; addMsg(shtml, getLastModalWin(),"bMsg@1;bAutoClose@0;"); playMsg();}
