...
function doKeyUp_win0(evt)
{
 ...
 if (key == 27)
 {
 var sCancelName = '#ICCancel'; var modObj = MTop().document.getElementById(MTop().PTMOD_ + + MTop().modId); if (top.isFModeLayout() && modObj && modObj.bModeless) {
...
window.doKeyPress_win0 = function (evt)
 ...
 var modObj = MTop().document.getElementById(MTop().PTMOD_ + MTop().modId); if (top.isFModeLayout() && modObj && modObj.bModeless && key == 27) 
 {}
 else
